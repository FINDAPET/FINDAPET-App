...
public class RightWSEngine: RightEngine, TransportEventClient, RightFramerEventClient, FrameCollectorDelegate, HTTPHandlerDelegate {
    ...
    private let frameHandler = RightFrameCollector()
    ...
    public func frameProcessed(event: RightFrameEvent) {
        switch event {
